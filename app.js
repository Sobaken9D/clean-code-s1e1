...
var createNewTaskElement = function(taskString){
  ...
  editInput.className = "list-item__text input_text input";
  ...
  deleteButtonImg.className = "delete-item__button__image";
  deleteButtonImg.alt = "cross for delete button";
...
var editTask=function(){
  ...
  var editBtn = listItem.querySelector(".edit-item__button");
  var containsClass = listItem.classList.contains("list-item_editing");
...
var taskCompleted=function(){
  ...
  var listItem=this.parentNode;
  listItem.querySelector('label').classList.toggle('list-item__label_crossed');
  // listItem[1].classList.add('list-item__label_crossed');
...
var bindTaskEvents=function(taskListItem,checkBoxEventHandler){
  ...
  var editButton = taskListItem.querySelector(".edit-item__button");
  var deleteButton = taskListItem.querySelector(".delete-item__button");
